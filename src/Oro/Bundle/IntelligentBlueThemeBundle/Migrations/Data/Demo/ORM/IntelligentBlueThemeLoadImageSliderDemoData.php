...
/**
 * Adds a content block with Image Slider content widget in it for Intelligent Blue Theme.
 */
class IntelligentBlueThemeLoadImageSliderDemoData extends AbstractFixture implements
    ...
    ContainerAwareInterface
{
    ...
    public const string INTELLIGENT_BLUE_HOME_PAGE_SLIDER = 'intelligent-blue-home-page-slider';
    ...
    public const SLIDES = [
        [
            ...
            'extraLargeImage' => 'promo-slider-blue-1-extra-large',
            'extraLargeImage2x' => 'promo-slider-blue-1-extra-large-2x',
            'largeImage' => 'promo-slider-blue-1-large',
            'largeImage2x' => 'promo-slider-blue-1-large-2x',
            'mediumImage' => 'promo-slider-blue-1-medium',
            'mediumImage2x' => 'promo-slider-blue-1-medium-2x',
            'smallImage' => 'promo-slider-blue-1-small',
            'smallImage2x' => 'promo-slider-blue-1-small-2x',
        ],
        [
            ...
            'extraLargeImage' => 'promo-slider-blue-2-extra-large',
            'extraLargeImage2x' => 'promo-slider-blue-2-extra-large-2x',
            'largeImage' => 'promo-slider-blue-2-large',
            'largeImage2x' => 'promo-slider-blue-2-extra-large-2x',
            'mediumImage' => 'promo-slider-blue-2-medium',
            'mediumImage2x' => 'promo-slider-blue-2-medium-2x',
            'smallImage' => 'promo-slider-blue-2-small',
            'smallImage2x' => 'promo-slider-blue-2-small-2x',
        ...
        [
            ...
            'loading' => ImageSlide::LOADING_LAZY,
            'fetchPriority' => ImageSlide::FETCH_PRIORITY_AUTO,
            'extraLargeImage' => 'promo-slider-blue-3-extra-large',
            'extraLargeImage2x' => 'promo-slider-blue-3-extra-large-2x',
            'largeImage' => 'promo-slider-blue-3-large',
            'largeImage2x' => 'promo-slider-blue-3-large-2x',
            'mediumImage' => 'promo-slider-blue-3-medium',
            'mediumImage2x' => 'promo-slider-blue-3-medium-2x',
            'smallImage' => 'promo-slider-blue-3-small',
            'smallImage2x' => 'promo-slider-blue-3-small-2x',
        ],
    ];
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $contentWidget = $this->getContentWidgetByName($manager, static::INTELLIGENT_BLUE_HOME_PAGE_SLIDER);
        ...
        $widget->setName(static::INTELLIGENT_BLUE_HOME_PAGE_SLIDER);
        ...
        $this->updateOrCreateContentBlock(
            ...
            '<div data-title="home-page-slider" data-type="image_slider" class="content-widget content-placeholder">
                {{ widget("intelligent-blue-home-page-slider") }}
            </div>'
        );
    }
    ...
    protected function updateOrCreateContentBlock(ObjectManager $manager, User $user, string $content): void
    {
        $contentBlock = $manager->getRepository(ContentBlock::class)
            ->findOneBy(['alias' => static::INTELLIGENT_BLUE_HOME_PAGE_SLIDER]);

        if (!$contentBlock instanceof ContentBlock) {
            $title = new LocalizedFallbackValue();
            $title->setString('Intelligent Blue Home Page Slider');
            ...
            $slider->setAlias(static::INTELLIGENT_BLUE_HOME_PAGE_SLIDER);
            $slider->addTitle($title);
            $slider->addContentVariant($variant);
            $manager->persist($slider);
        } else {
            $html = file_get_contents(
                $this->getFilePathsFromLocator('@OroCMSBundle/Migrations/Data/Demo/ORM/data/frontpage_slider.html')
            );
    ...
    {
        $imagePath = $this->getFilePathsFromLocator(
            sprintf('@OroIntelligentBlueThemeBundle/Migrations/Data/Demo/ORM/data/promo-slider/%s.png', $filename)
        );
    ...
    private function getFilePathsFromLocator(string $path): array|string
    {
