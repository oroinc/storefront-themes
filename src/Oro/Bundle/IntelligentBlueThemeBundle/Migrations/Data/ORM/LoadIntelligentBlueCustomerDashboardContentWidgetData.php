...
/**
 * Loads customer dashboards datagrid content widget data and configures theme configuration for Intelligent Blue Theme
 */
class LoadIntelligentBlueCustomerDashboardContentWidgetData extends LoadCustomerDashboardContentWidgetData
{
    #[\Override]
