...
/**
 * Sets contact_us_form widget for theme configuration for Intelligent Blue Theme
 */
class SetContactUsFormForIntelligentBlueThemeConfiguration extends AbstractLoadFrontendTheme implements
